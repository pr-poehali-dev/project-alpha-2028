...
const QUICK_CHIPS = ["Кто ты?", "Покажи проекты", "Какой опыт?"]

const RESPONSES: Record<string, string> = {
  "Кто ты?": "Я AI-помощник инженера! Помогаю показать проекты и рассказать о его опыте. Хочешь узнать больше?",
  "Покажи проекты":
    "С удовольствием! Здесь собраны инженерные разработки и технические решения.",
  "Какой опыт?":
    "Большой опыт в инженерных проектах! Работа с системами, оптимизация процессов и внедрение инноваций.",
}

const ACTION_RESPONSES: Record<string, { response: string; action: string }> = {
  "открой проекты": { response: "Открываю галерею проектов!", action: "art" },
  "покажи проекты": { response: "Показываю инженерные проекты!", action: "art" },
  ...
  "покажи обо мне": { response: "Расскажу об инженере!", action: "about" },
  "открой статьи": { response: "Открываю технические статьи!", action: "writings" },
  ...
  const handleInputSubmit = (e: React.FormEvent) => {
    ...
    if (actionMatch) {
      ...
      const defaultResponse =
        "Интересно! Я помогу изучить инженерный опыт. Попробуй написать «открой проекты» или «покажи резюме»!"
