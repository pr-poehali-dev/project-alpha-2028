export function MiniAppArt() {
  const artworks = [
    { title: "Умный завод", medium: "IoT & Automation", year: "2026" },
    { title: "Гидравлическая система", medium: "CAD/SolidWorks", year: "2025" },
    { title: "Роботизированная линия", medium: "PLC Programming", year: "2025" },
    { title: "Энергоэффективное охлаждение", medium: "Thermal Analysis", year: "2024" },
    { title: "Модульная конструкция", medium: "3D Modeling", year: "2024" },
    { title: "Система мониторинга", medium: "Python & Sensors", year: "2023" },
  ]

  return (
    <div className="max-w-4xl">
      <h2 className="text-4xl font-black mb-6 border-b-[3px] border-black pb-2">Инженерные проекты</h2>
        ...
        {artworks.map((artwork, i) => (
          ...
          >
            <div className="aspect-square bg-gradient-to-br from-[#FF2E63] to-[#FF6B9D] border-b-[3px] border-black flex items-center justify-center">
              <span className="text-white font-black text-lg">ПРОЕКТ</span>
            </div>
            <div className="p-4">
